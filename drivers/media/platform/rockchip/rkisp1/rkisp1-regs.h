...
#define RKISP1_PACK_4BYTE(a, b, c, d)	\
	(((a) & 0xFF) << 0 | ((b) & 0xFF) << 8 | \
	 ((c) & 0xFF) << 16 | ((d) & 0xFF) << 24)

#define RKISP1_PACK_2SHORT(a, b) (((a)&0xFFFF) << 0 | ((b)&0xFFFF) << 16)

/* The measurement done bit must only be set to start a new measurement,
 * otherwise it acts as a kind of write protect. */
...
/* ISP CTRL1 */
#define RKISP2_SYS_YNR_FST		BIT(23)
#define RKISP2_SYS_ADRC_FST		BIT(24)
#define RKISP2_SYS_DHAZ_FST		BIT(25)
#define RKISP2_SYS_CNR_FST		BIT(26)
#define RKISP2_SYS_BAY3D_FST		BIT(27)
#define RKISP2_SYS_BIGMODE_FORCEEN	BIT(28)
#define RKISP2_SYS_BIGMODE_MANUAL	BIT(29)
...
#define RKISP1_CIF_ISP_LSC_LUT_ERR_V21			BIT(16)
#define RKISP1_CIF_ISP_FLASH_CAP			BIT(17)
#define RKISP1_CIF_ISP_EXP_END				BIT(18)
#define RKISP1_CIF_ISP_VSM_END				BIT(19)
#define RKISP1_CIF_ISP_OUT_QUARTER_V21			BIT(19)
#define RKISP1_CIF_ISP_HDR_DONE_V21			BIT(20)
#define RKISP1_CIF_ISP_DEHAZE_DONE_V21			BIT(21)
#define RKISP1_CIF_ISP_GAIN_DONE_V21			BIT(22)

#define RKISP1_CIF_ISP_RAWAE_CH0_DONE_V21		BIT(1)
#define RKISP1_CIF_ISP_RAWHIST_CH1_DONE_V21		BIT(4)	/* BIG1 */
#define RKISP1_CIF_ISP_RAWHIST_CH0_DONE_V21		BIT(5)	/* LITE */
#define RKISP1_CIF_ISP_RAWHIST_CH2_DONE_V21		BIT(6)	/* BIG2 */
#define RKISP1_CIF_ISP_RAWHIST_CH3_DONE_V21		BIT(7)	/* BIG3 */
#define RKISP1_CIF_ISP_RAWAF_DONE_V21			BIT(10)
...
/* ISP HISTOGRAM CALCULATION : ISP_RAWHIST_LITE */
#define RKISP1_CIF_ISP_HIST_CTRL_EN_SET_V21(x)		(((x) & 0x01) << 0)
#define RKISP1_CIF_ISP_HIST_CTRL_EN_MASK_V21		RKISP1_CIF_ISP_HIST_CTRL_EN_SET_V21(0x01)
#define RKISP1_CIF_ISP_HIST_CTRL_STEPSIZE_SET_V21(x)	(((x) & 0x07) << 1)
#define RKISP1_CIF_ISP_HIST_CTRL_DBGEN_SET_V21(x)	(((x) & 0x01) << 7)
#define RKISP1_CIF_ISP_HIST_CTRL_MODE_SET_V21(x)	(((x) & 0x07) << 8)
#define RKISP1_CIF_ISP_HIST_CTRL_MODE_GET_V21(x)	(((x) >> 8) & 0x07)
#define RKISP1_CIF_ISP_HIST_CTRL_MODE_MASK_V21		RKISP1_CIF_ISP_HIST_CTRL_MODE_SET_V21(0x07)
//#define RKISP1_CIF_ISP_HIST_CTRL_AUTOSTOP_SET_V21(x)	(((x) & 0x01) << 11)
#define RKISP1_CIF_ISP_HIST_CTRL_WATERLINE_SET_V21(x)	(((x) & 0xFFF) << 12)
#define RKISP1_CIF_ISP_HIST_CTRL_DATASEL_SET_V21(x)	(((x) & 0x07) << 24)
//#define RKISP1_CIF_ISP_HIST_CTRL_INTRSEL_SET_V21(x)	(((x) & 0x01) << 27)
#define RKISP1_CIF_ISP_HIST_CTRL_WNDNUM_SET_V21(x)	(((x) & 0x03) << 28)
#define RKISP1_CIF_ISP_HIST_ROW_NUM_V21			5
#define RKISP1_CIF_ISP_HIST_COLUMN_NUM_V21		5
#define RKISP1_CIF_ISP_HIST_WEIGHT_REG_SIZE_V21	\
				(RKISP1_CIF_ISP_HIST_ROW_NUM_V21 * RKISP1_CIF_ISP_HIST_COLUMN_NUM_V21)

#define RKISP1_CIF_ISP_HIST_WEIGHT_SET_V21(v0, v1, v2, v3)	\
				(((v0) & 0x3F) | (((v1) & 0x3F) << 8) |\
				(((v2) & 0x3F) << 16) |\
				(((v3) & 0x3F) << 24))

#define RKISP1_CIF_ISP_HIST_BIG_WEIGHT_SET(v0, v1, v2, v3, v4)	\
				(((v0) & 0x3F) | (((v1) & 0x3F) << 6) |\
				(((v2) & 0x3F) << 12) |	(((v3) & 0x3F) << 18) |\
				(((v4) & 0x3F) << 24))

#define RKISP1_CIF_ISP_HIST_OFFS_SET_V21(v0, v1)	\
				(((v0) & 0x1FFF) | (((v1) & 0x1FFF) << 16))
#define RKISP1_CIF_ISP_HIST_SIZE_SET_V21(v0, v1)	\
				(((v0) & 0x7FF) | (((v1) & 0x7FF) << 16))

#define RKISP1_CIF_ISP_HIST_GET_BIN_V21(x)	(x)
...
/* Demosaic:  ISP_DEBAYER_2500 */
#define RKISP1_CIF_DEBAYER_EN_V21			BIT(0)
#define RKISP1_CIF_DEBAYER_EN_G_FILTER_V21		BIT(4)
#define RKISP1_CIF_DEBAYER_EN_C_FILTER_V21		BIT(8)
...
#define RKISP1_CIF_ISP_EXP_GET_MEAN_g_V21(x)		((x) & 0xFFF)
#define RKISP1_CIF_ISP_EXP_GET_MEAN_b_V21(x)		(((x) >> 12) & 0x3FF)
#define RKISP1_CIF_ISP_EXP_GET_MEAN_r_V21(x)		(((x) >> 22) & 0x3FF)
...
#define RKISP1_CIF_ISP_AFM_GAMMA_EN			BIT(1)
...
#define RKISP2_YNR_EN			BIT(0)
#define RKISP2_CNR_EN			BIT(0)
#define RKISP2_SHARP_EN			BIT(0)
#define RKISP2_BAYNR_EN			BIT(0)
#define RKISP2_BAY3D_EN			BIT(0)

/* CCM */
#define RKISP21_CCM_EN					BIT(0)
#define RKISP21_CCM_HIGHY_ALPHA_ADJ_DIS			BIT(1)
...
//This CTRL1 register is for RKISP2x only and has some overlap to the ACQ_PROP register
#define RKISP1_CIF_ISP_CTRL1			(RKISP1_CIF_ISP_BASE + 0x00000004)
...
#define RKISP1_CIF_ISP3A_IMSC_V21		(RKISP1_CIF_ISP_BASE + 0x000001d0)
#define RKISP1_CIF_ISP3A_RIS_V21		(RKISP1_CIF_ISP_BASE + 0x000001d4)
#define RKISP1_CIF_ISP3A_MIS_V21		(RKISP1_CIF_ISP_BASE + 0x000001d8)
#define RKISP1_CIF_ISP3A_ICR_V21		(RKISP1_CIF_ISP_BASE + 0x000001dc)
...
#define RKISP2_GAMMA_OUT_BASE			0x00000900
#define RKISP2_GAMMA_OUT_CTRL			(RKISP2_GAMMA_OUT_BASE + 0x00000)
#define RKISP2_GAMMA_OUT_OFFSET			(RKISP2_GAMMA_OUT_BASE + 0x00004)
#define RKISP2_GAMMA_OUT_Y0			(RKISP2_GAMMA_OUT_BASE + 0x00010)
#define RKISP2_GAMMA_OUT_Y1			(RKISP2_GAMMA_OUT_BASE + 0x00014)
#define RKISP2_GAMMA_OUT_Y2			(RKISP2_GAMMA_OUT_BASE + 0x00018)
#define RKISP2_GAMMA_OUT_Y3			(RKISP2_GAMMA_OUT_BASE + 0x0001c)
#define RKISP2_GAMMA_OUT_Y4			(RKISP2_GAMMA_OUT_BASE + 0x00020)
#define RKISP2_GAMMA_OUT_Y5			(RKISP2_GAMMA_OUT_BASE + 0x00024)
#define RKISP2_GAMMA_OUT_Y6			(RKISP2_GAMMA_OUT_BASE + 0x00028)
#define RKISP2_GAMMA_OUT_Y7			(RKISP2_GAMMA_OUT_BASE + 0x0002c)
#define RKISP2_GAMMA_OUT_Y8			(RKISP2_GAMMA_OUT_BASE + 0x00030)
#define RKISP2_GAMMA_OUT_Y9			(RKISP2_GAMMA_OUT_BASE + 0x00034)
#define RKISP2_GAMMA_OUT_Y10			(RKISP2_GAMMA_OUT_BASE + 0x00038)
#define RKISP2_GAMMA_OUT_Y11			(RKISP2_GAMMA_OUT_BASE + 0x0003c)
#define RKISP2_GAMMA_OUT_Y12			(RKISP2_GAMMA_OUT_BASE + 0x00040)
#define RKISP2_GAMMA_OUT_Y13			(RKISP2_GAMMA_OUT_BASE + 0x00044)
#define RKISP2_GAMMA_OUT_Y14			(RKISP2_GAMMA_OUT_BASE + 0x00048)
#define RKISP2_GAMMA_OUT_Y15			(RKISP2_GAMMA_OUT_BASE + 0x0004c)
#define RKISP2_GAMMA_OUT_Y16			(RKISP2_GAMMA_OUT_BASE + 0x00050)
#define RKISP2_GAMMA_OUT_Y17			(RKISP2_GAMMA_OUT_BASE + 0x00054)
#define RKISP2_GAMMA_OUT_Y18			(RKISP2_GAMMA_OUT_BASE + 0x00058)
#define RKISP2_GAMMA_OUT_Y19			(RKISP2_GAMMA_OUT_BASE + 0x0005c)
#define RKISP2_GAMMA_OUT_Y20			(RKISP2_GAMMA_OUT_BASE + 0x00060)
#define RKISP2_GAMMA_OUT_Y21			(RKISP2_GAMMA_OUT_BASE + 0x00064)
#define RKISP2_GAMMA_OUT_Y22			(RKISP2_GAMMA_OUT_BASE + 0x00068)
#define RKISP2_GAMMA_OUT_Y23			(RKISP2_GAMMA_OUT_BASE + 0x0006c)
#define RKISP2_GAMMA_OUT_Y24			(RKISP2_GAMMA_OUT_BASE + 0x00070)
#define RKISP2_GAMMA_OUT_Y25			(RKISP2_GAMMA_OUT_BASE + 0x00074)
#define RKISP2_GAMMA_OUT_Y26			(RKISP2_GAMMA_OUT_BASE + 0x00078)
#define RKISP2_GAMMA_OUT_Y27			(RKISP2_GAMMA_OUT_BASE + 0x0007c)
#define RKISP2_GAMMA_OUT_Y28			(RKISP2_GAMMA_OUT_BASE + 0x00080)
#define RKISP2_GAMMA_OUT_Y29			(RKISP2_GAMMA_OUT_BASE + 0x00084)
#define RKISP2_GAMMA_OUT_Y30			(RKISP2_GAMMA_OUT_BASE + 0x00088)
#define RKISP2_GAMMA_OUT_Y31			(RKISP2_GAMMA_OUT_BASE + 0x0008c)
#define RKISP2_GAMMA_OUT_Y32			(RKISP2_GAMMA_OUT_BASE + 0x00090)
#define RKISP2_GAMMA_OUT_Y33			(RKISP2_GAMMA_OUT_BASE + 0x00094)
#define RKISP2_GAMMA_OUT_Y34			(RKISP2_GAMMA_OUT_BASE + 0x00098)
#define RKISP2_GAMMA_OUT_Y35			(RKISP2_GAMMA_OUT_BASE + 0x0009c)
#define RKISP2_GAMMA_OUT_Y36			(RKISP2_GAMMA_OUT_BASE + 0x000a0)
#define RKISP2_GAMMA_OUT_Y37			(RKISP2_GAMMA_OUT_BASE + 0x000a4)
#define RKISP2_GAMMA_OUT_Y38			(RKISP2_GAMMA_OUT_BASE + 0x000a8)
#define RKISP2_GAMMA_OUT_Y39			(RKISP2_GAMMA_OUT_BASE + 0x000ac)
#define RKISP2_GAMMA_OUT_Y40			(RKISP2_GAMMA_OUT_BASE + 0x000b0)
...
#define RKISP2_MI_WR_ID				(RKISP1_CIF_MI_BASE + 0x00154)
#define RKISP2_MI_MP_WR_Y_IRQ_OFFS2		(RKISP1_CIF_MI_BASE + 0x001e0)
#define RKISP2_MI_MP_WR_Y_IRQ_OFFS2_SHD		(RKISP1_CIF_MI_BASE + 0x001e4)
#define RKISP2_MI_MP_WR_Y_LLENGTH		(RKISP1_CIF_MI_BASE + 0x001e8)
#define RKISP2_MI_WR_CTRL2			(RKISP1_CIF_MI_BASE + 0x00400)
#define RKISP2_MI_WR_ID2			(RKISP1_CIF_MI_BASE + 0x00404)
#define RKISP2_MI_RD_CTRL2			(RKISP1_CIF_MI_BASE + 0x00408)
#define RKISP2_MI_RD_ID				(RKISP1_CIF_MI_BASE + 0x0040c)
#define RKISP2_MI_RD_FIFO_LEVEL			(RKISP1_CIF_MI_BASE + 0x0041c)
#define RKISP2_MI_RAW0_WR_BASE			(RKISP1_CIF_MI_BASE + 0x00420)
#define RKISP2_MI_RAW0_WR_SIZE			(RKISP1_CIF_MI_BASE + 0x00424)
#define RKISP2_MI_RAW0_WR_LENGTH		(RKISP1_CIF_MI_BASE + 0x00428)
#define RKISP2_MI_RAW0_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x0042c)
#define RKISP2_MI_RAW1_WR_BASE			(RKISP1_CIF_MI_BASE + 0x00430)
#define RKISP2_MI_RAW1_WR_SIZE			(RKISP1_CIF_MI_BASE + 0x00434)
#define RKISP2_MI_RAW1_WR_LENGTH		(RKISP1_CIF_MI_BASE + 0x00438)
#define RKISP2_MI_RAW1_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x0043c)
#define RKISP2_MI_RAW2_WR_BASE			(RKISP1_CIF_MI_BASE + 0x00440)
#define RKISP2_MI_RAW2_WR_SIZE			(RKISP1_CIF_MI_BASE + 0x00444)
#define RKISP2_MI_RAW2_WR_LENGTH		(RKISP1_CIF_MI_BASE + 0x00448)
#define RKISP2_MI_RAW2_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x0044c)
#define RKISP2_MI_RAW3_WR_BASE			(RKISP1_CIF_MI_BASE + 0x00450)
#define RKISP2_MI_RAW3_WR_SIZE			(RKISP1_CIF_MI_BASE + 0x00454)
#define RKISP2_MI_RAW3_WR_LENGTH		(RKISP1_CIF_MI_BASE + 0x00458)
#define RKISP2_MI_RAW3_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x0045c)
#define RKISP2_MI_RW0_WR_LAST_FRAME_ADDR	(RKISP1_CIF_MI_BASE + 0x00460)
#define RKISP2_MI_RW1_WR_LAST_FRAME_ADDR	(RKISP1_CIF_MI_BASE + 0x00464)
#define RKISP2_MI_RW2_WR_LAST_FRAME_ADDR	(RKISP1_CIF_MI_BASE + 0x00468)
#define RKISP2_MI_RW3_WR_LAST_FRAME_ADDR	(RKISP1_CIF_MI_BASE + 0x0046c)
#define RKISP2_MI_RAW0_RD_BASE			(RKISP1_CIF_MI_BASE + 0x00470)
#define RKISP2_MI_RAW0_RD_LENGTH		(RKISP1_CIF_MI_BASE + 0x00474)
#define RKISP2_MI_RAW0_RD_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00478)
#define RKISP2_MI_RAW1_RD_BASE			(RKISP1_CIF_MI_BASE + 0x00480)
#define RKISP2_MI_RAW1_RD_LENGTH		(RKISP1_CIF_MI_BASE + 0x00484)
#define RKISP2_MI_RAW1_RD_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00488)
#define RKISP2_MI_RAW2_RD_BASE			(RKISP1_CIF_MI_BASE + 0x00490)
#define RKISP2_MI_RAW2_RD_LENGTH		(RKISP1_CIF_MI_BASE + 0x00494)
#define RKISP2_MI_RAW2_RD_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00498)
#define RKISP2_MI_RAWFBC_WR_BURST_LEN		(RKISP1_CIF_MI_BASE + 0x00500)
#define RKISP2_MI_RAWFBC_RD_BURST_LEN		(RKISP1_CIF_MI_BASE + 0x00504)
#define RKISP2_MI_RAW0FBC_WR_BASE		(RKISP1_CIF_MI_BASE + 0x00510)
#define RKISP2_MI_RAW1FBC_WR_BASE		(RKISP1_CIF_MI_BASE + 0x00514)
#define RKISP2_MI_RAW0FBC_RD_BASE		(RKISP1_CIF_MI_BASE + 0x00518)
#define RKISP2_MI_RAW1FBC_RD_BASE		(RKISP1_CIF_MI_BASE + 0x0051c)
#define RKISP2_MI_RAW0FBC_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00520)
#define RKISP2_MI_RAW1FBC_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00524)
#define RKISP2_MI_RAW0FBC_RD_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00528)
#define RKISP2_MI_RAW1FBC_RD_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x0052c)
#define RKISP2_MI_LUT_3D_RD_BASE		(RKISP1_CIF_MI_BASE + 0x00540)
#define RKISP2_MI_LUT_LSC_RD_BASE		(RKISP1_CIF_MI_BASE + 0x00544)
#define RKISP2_MI_LUT_LDCH_RD_BASE		(RKISP1_CIF_MI_BASE + 0x00548)
#define RKISP2_MI_LUT_3D_RD_WSIZE		(RKISP1_CIF_MI_BASE + 0x00550)
#define RKISP2_MI_LUT_LSC_RD_WSIZE		(RKISP1_CIF_MI_BASE + 0x00554)
#define RKISP2_MI_LUT_LDCH_RD_H_WSIZE		(RKISP1_CIF_MI_BASE + 0x00558)
#define RKISP2_MI_LUT_LDCH_RD_V_SIZE		(RKISP1_CIF_MI_BASE + 0x0055c)
#define RKISP2_MI_DBR_WR_BASE			(RKISP1_CIF_MI_BASE + 0x00560)
#define RKISP2_MI_DBR_WR_SIZE			(RKISP1_CIF_MI_BASE + 0x00564)
#define RKISP2_MI_DBR_WR_LENGTH			(RKISP1_CIF_MI_BASE + 0x00568)
#define RKISP2_MI_DBR_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x0056c)
#define RKISP2_MI_DBR_RD_BASE			(RKISP1_CIF_MI_BASE + 0x00570)
#define RKISP2_MI_DBR_RD_LENGTH			(RKISP1_CIF_MI_BASE + 0x00574)
#define RKISP2_MI_DBR_RD_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00578)
#define RKISP2_MI_SWS_3A_WR_BASE		(RKISP1_CIF_MI_BASE + 0x0057c)
#define RKISP2_MI_GAIN_WR_BASE			(RKISP1_CIF_MI_BASE + 0x00580)
#define RKISP2_MI_GAIN_WR_SIZE			(RKISP1_CIF_MI_BASE + 0x00584)
#define RKISP2_MI_GAIN_WR_LENGTH		(RKISP1_CIF_MI_BASE + 0x00588)
#define RKISP2_MI_GAIN_WR_BASE2			(RKISP1_CIF_MI_BASE + 0x0058c)
#define RKISP2_MI_GAIN_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x00590)

#define RKISP2_MI_BAY3D_WR_BASE			(RKISP1_CIF_MI_BASE + 0x005a0)
#define RKISP2_MI_BAY3D_WR_SIZE			(RKISP1_CIF_MI_BASE + 0x005a4)
#define RKISP2_MI_BAY3D_WR_LENGTH		(RKISP1_CIF_MI_BASE + 0x005a8)
#define RKISP2_MI_BAY3D_WR_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x005ac)
#define RKISP2_MI_BAY3D_RD_BASE			(RKISP1_CIF_MI_BASE + 0x005b0)
#define RKISP2_MI_BAY3D_RD_LENGTH		(RKISP1_CIF_MI_BASE + 0x005b4)
#define RKISP2_MI_BAY3D_RD_BASE_SHD		(RKISP1_CIF_MI_BASE + 0x005b8)
...
/* Aditional registers for RKISP V2.1 */
#define RKISP2_CCM_BASE				0x00000700
#define RKISP2_CCM_CTRL				(RKISP2_CCM_BASE + 0x00000)
#define RKISP2_CCM_COEFF0_R			(RKISP2_CCM_BASE + 0x00004)
#define RKISP2_CCM_COEFF1_R			(RKISP2_CCM_BASE + 0x00008)
#define RKISP2_CCM_COEFF0_G			(RKISP2_CCM_BASE + 0x0000c)
#define RKISP2_CCM_COEFF1_G			(RKISP2_CCM_BASE + 0x00010)
#define RKISP2_CCM_COEFF0_B			(RKISP2_CCM_BASE + 0x00014)
#define RKISP2_CCM_COEFF1_B			(RKISP2_CCM_BASE + 0x00018)
#define RKISP2_CCM_COEFF0_Y			(RKISP2_CCM_BASE + 0x0001c)
#define RKISP2_CCM_COEFF1_Y			(RKISP2_CCM_BASE + 0x00020)
#define RKISP2_CCM_ALP_Y0			(RKISP2_CCM_BASE + 0x00024)
#define RKISP2_CCM_ALP_Y1			(RKISP2_CCM_BASE + 0x00028)
#define RKISP2_CCM_ALP_Y2			(RKISP2_CCM_BASE + 0x0002c)
#define RKISP2_CCM_ALP_Y3			(RKISP2_CCM_BASE + 0x00030)
#define RKISP2_CCM_ALP_Y4			(RKISP2_CCM_BASE + 0x00034)
#define RKISP2_CCM_ALP_Y5			(RKISP2_CCM_BASE + 0x00038)
#define RKISP2_CCM_ALP_Y6			(RKISP2_CCM_BASE + 0x0003c)
#define RKISP2_CCM_ALP_Y7			(RKISP2_CCM_BASE + 0x00040)
#define RKISP2_CCM_ALP_Y8			(RKISP2_CCM_BASE + 0x00044)
#define RKISP2_CCM_BOUND_BIT			(RKISP2_CCM_BASE + 0x00048)
...
#define RKISP2_DEBAYER_BASE			0x00002500
#define RKISP2_DEBAYER_CONTROL			(RKISP2_DEBAYER_BASE + 0x00000)
#define RKISP2_DEBAYER_G_INTERP			(RKISP2_DEBAYER_BASE + 0x00004)
#define RKISP2_DEBAYER_G_INTERP_FILTER1		(RKISP2_DEBAYER_BASE + 0x00008)
#define RKISP2_DEBAYER_G_INTERP_FILTER2		(RKISP2_DEBAYER_BASE + 0x0000c)
#define RKISP2_DEBAYER_G_FILTER			(RKISP2_DEBAYER_BASE + 0x00010)
#define RKISP2_DEBAYER_C_FILTER			(RKISP2_DEBAYER_BASE + 0x00014)

#define RKISP2_YNR_BASE				0x00002700
#define RKISP2_YNR_GLOBAL_CTRL			(RKISP2_YNR_BASE + 0x00000)
#define RKISP2_YNR_RNR_MAX_R			(RKISP2_YNR_BASE + 0x00004)
#define RKISP2_YNR_LOWNR_CTRL0			(RKISP2_YNR_BASE + 0x00010)
#define RKISP2_YNR_LOWNR_CTRL1			(RKISP2_YNR_BASE + 0x00014)
#define RKISP2_YNR_LOWNR_CTRL2			(RKISP2_YNR_BASE + 0x00018)
#define RKISP2_YNR_LOWNR_CTRL3			(RKISP2_YNR_BASE + 0x0001c)
#define RKISP2_YNR_HIGHNR_CTRL0			(RKISP2_YNR_BASE + 0x00020)
#define RKISP2_YNR_HIGHNR_CTRL1			(RKISP2_YNR_BASE + 0x00024)
#define RKISP2_YNR_HIGHNR_BASE_FILTER_WEIGHT	(RKISP2_YNR_BASE + 0x00028)
#define RKISP2_YNR_GAUSS1_COEFF			(RKISP2_YNR_BASE + 0x00030)
#define RKISP2_YNR_GAUSS2_COEFF			(RKISP2_YNR_BASE + 0x00034)
#define RKISP2_YNR_DIRECTION_W_0_3		(RKISP2_YNR_BASE + 0x00038)
#define RKISP2_YNR_DIRECTION_W_4_7		(RKISP2_YNR_BASE + 0x0003c)
#define RKISP2_YNR_SGM_DX_0_1			(RKISP2_YNR_BASE + 0x00040)
#define RKISP2_YNR_SGM_DX_2_3			(RKISP2_YNR_BASE + 0x00044)
#define RKISP2_YNR_SGM_DX_4_5			(RKISP2_YNR_BASE + 0x00048)
#define RKISP2_YNR_SGM_DX_6_7			(RKISP2_YNR_BASE + 0x0004c)
#define RKISP2_YNR_SGM_DX_8_9			(RKISP2_YNR_BASE + 0x00050)
#define RKISP2_YNR_SGM_DX_10_11			(RKISP2_YNR_BASE + 0x00055)
#define RKISP2_YNR_SGM_DX_12_13			(RKISP2_YNR_BASE + 0x00058)
#define RKISP2_YNR_SGM_DX_14_15			(RKISP2_YNR_BASE + 0x0005c)
#define RKISP2_YNR_SGM_DX_16			(RKISP2_YNR_BASE + 0x00060)
#define RKISP2_YNR_LSGM_Y_0_1			(RKISP2_YNR_BASE + 0x00070)
#define RKISP2_YNR_LSGM_Y_2_3			(RKISP2_YNR_BASE + 0x00074)
#define RKISP2_YNR_LSGM_Y_4_5			(RKISP2_YNR_BASE + 0x00078)
#define RKISP2_YNR_LSGM_Y_6_7			(RKISP2_YNR_BASE + 0x0007c)
#define RKISP2_YNR_LSGM_Y_8_9			(RKISP2_YNR_BASE + 0x00080)
#define RKISP2_YNR_LSGM_Y_10_11			(RKISP2_YNR_BASE + 0x00084)
#define RKISP2_YNR_LSGM_Y_12_13			(RKISP2_YNR_BASE + 0x00088)
#define RKISP2_YNR_LSGM_Y_14_15			(RKISP2_YNR_BASE + 0x0008c)
#define RKISP2_YNR_LSGM_Y_16			(RKISP2_YNR_BASE + 0x00090)
#define RKISP2_YNR_HSGM_Y_0_1			(RKISP2_YNR_BASE + 0x000a0)
#define RKISP2_YNR_HSGM_Y_2_3			(RKISP2_YNR_BASE + 0x000a4)
#define RKISP2_YNR_HSGM_Y_4_5			(RKISP2_YNR_BASE + 0x000a8)
#define RKISP2_YNR_HSGM_Y_6_7			(RKISP2_YNR_BASE + 0x000ac)
#define RKISP2_YNR_HSGM_Y_8_9			(RKISP2_YNR_BASE + 0x000b0)
#define RKISP2_YNR_HSGM_Y_10_11			(RKISP2_YNR_BASE + 0x000b4)
#define RKISP2_YNR_HSGM_Y_12_13			(RKISP2_YNR_BASE + 0x000b8)
#define RKISP2_YNR_HSGM_Y_14_15			(RKISP2_YNR_BASE + 0x000bc)
#define RKISP2_YNR_HSGM_Y_16			(RKISP2_YNR_BASE + 0x000c0)
#define RKISP2_YNR_RNR_STRENGTH03		(RKISP2_YNR_BASE + 0x000d0)
#define RKISP2_YNR_RNR_STRENGTH47		(RKISP2_YNR_BASE + 0x000d4)
#define RKISP2_YNR_RNR_STRENGTH8B		(RKISP2_YNR_BASE + 0x000d8)
#define RKISP2_YNR_RNR_STRENGTHCF		(RKISP2_YNR_BASE + 0x000dc)
#define RKISP2_YNR_RNR_STRENGTH16		(RKISP2_YNR_BASE + 0x000e0)

#define RKISP2_CNR_BASE				0x00002800
#define RKISP2_CNR_CTRL				(RKISP2_CNR_BASE + 0x00000)
#define RKISP2_CNR_EXGAIN			(RKISP2_CNR_BASE + 0x00004)
#define RKISP2_CNR_GAIN_PARA			(RKISP2_CNR_BASE + 0x00008)
#define RKISP2_CNR_GAIN_UV_PARA			(RKISP2_CNR_BASE + 0x0000c)
#define RKISP2_CNR_LMED3			(RKISP2_CNR_BASE + 0x00010)
#define RKISP2_CNR_LBF5_GAIN			(RKISP2_CNR_BASE + 0x00014)
#define RKISP2_CNR_LBF5_WEITD0_3		(RKISP2_CNR_BASE + 0x00018)
#define RKISP2_CNR_LBF5_WEITD4			(RKISP2_CNR_BASE + 0x0001c)
#define RKISP2_CNR_HMED3			(RKISP2_CNR_BASE + 0x00020)
#define RKISP2_CNR_HBF5				(RKISP2_CNR_BASE + 0x00024)
#define RKISP2_CNR_LBF3				(RKISP2_CNR_BASE + 0x00028)

#define RKISP2_SHARP_BASE			0x00002900
#define RKISP2_SHARP_SHARP_EN			(RKISP2_SHARP_BASE + 0x00000)
#define RKISP2_SHARP_SHARP_RATIO		(RKISP2_SHARP_BASE + 0x00004)
#define RKISP2_SHARP_SHARP_LUMA_DX		(RKISP2_SHARP_BASE + 0x00008)
#define RKISP2_SHARP_SHARP_PBF_SIGMA_INV_0	(RKISP2_SHARP_BASE + 0x0000c)
#define RKISP2_SHARP_SHARP_PBF_SIGMA_INV_1	(RKISP2_SHARP_BASE + 0x00010)
#define RKISP2_SHARP_SHARP_PBF_SIGMA_INV_2	(RKISP2_SHARP_BASE + 0x00014)
#define RKISP2_SHARP_SHARP_BF_SIGMA_INV_0	(RKISP2_SHARP_BASE + 0x00018)
#define RKISP2_SHARP_SHARP_BF_SIGMA_INV_1	(RKISP2_SHARP_BASE + 0x0001c)
#define RKISP2_SHARP_SHARP_BF_SIGMA_INV_2	(RKISP2_SHARP_BASE + 0x00020)
#define RKISP2_SHARP_SHARP_SIGMA_SHIFT		(RKISP2_SHARP_BASE + 0x00024)
#define RKISP2_SHARP_SHARP_EHF_TH_0		(RKISP2_SHARP_BASE + 0x00028)
#define RKISP2_SHARP_SHARP_EHF_TH_1		(RKISP2_SHARP_BASE + 0x0002c)
#define RKISP2_SHARP_SHARP_EHF_TH_2		(RKISP2_SHARP_BASE + 0x00030)
#define RKISP2_SHARP_SHARP_CLIP_HF_0		(RKISP2_SHARP_BASE + 0x00034)
#define RKISP2_SHARP_SHARP_CLIP_HF_1		(RKISP2_SHARP_BASE + 0x00038)
#define RKISP2_SHARP_SHARP_CLIP_HF_2		(RKISP2_SHARP_BASE + 0x0003c)
#define RKISP2_SHARP_SHARP_PBF_COEF		(RKISP2_SHARP_BASE + 0x00040)
#define RKISP2_SHARP_SHARP_BF_COEF		(RKISP2_SHARP_BASE + 0x00044)
#define RKISP2_SHARP_SHARP_GAUS_COEF		(RKISP2_SHARP_BASE + 0x00048)

#define RKISP2_GIC_BASE				0x00002F00
#define RKISP2_GIC_CONTROL			(RKISP2_GIC_BASE + 0x00000)
#define RKISP2_GIC_DIFF_PARA1			(RKISP2_GIC_BASE + 0x00004)
#define RKISP2_GIC_DIFF_PARA2			(RKISP2_GIC_BASE + 0x00008)
#define RKISP2_GIC_DIFF_PARA3			(RKISP2_GIC_BASE + 0x0000c)
#define RKISP2_GIC_DIFF_PARA4			(RKISP2_GIC_BASE + 0x00010)
#define RKISP2_GIC_NOISE_PARA1			(RKISP2_GIC_BASE + 0x00014)
#define RKISP2_GIC_NOISE_PARA2			(RKISP2_GIC_BASE + 0x00018)
#define RKISP2_GIC_NOISE_PARA3			(RKISP2_GIC_BASE + 0x0001c)
#define RKISP2_GIC_SIGMA_VALUE0			(RKISP2_GIC_BASE + 0x00020)
#define RKISP2_GIC_SIGMA_VALUE1			(RKISP2_GIC_BASE + 0x00024)
#define RKISP2_GIC_SIGMA_VALUE2			(RKISP2_GIC_BASE + 0x00028)
#define RKISP2_GIC_SIGMA_VALUE3			(RKISP2_GIC_BASE + 0x0002c)
#define RKISP2_GIC_SIGMA_VALUE4			(RKISP2_GIC_BASE + 0x00030)
#define RKISP2_GIC_SIGMA_VALUE5			(RKISP2_GIC_BASE + 0x00034)
#define RKISP2_GIC_SIGMA_VALUE6			(RKISP2_GIC_BASE + 0x00038)
#define RKISP2_GIC_SIGMA_VALUE7			(RKISP2_GIC_BASE + 0x0003c)
#define RKISP2_GIC_NOISE_CTRL0			(RKISP2_GIC_BASE + 0x00040)
#define RKISP2_GIC_NOISE_CTRL1			(RKISP2_GIC_BASE + 0x00044)

#define RKISP2_BLS_BASE				0x00003000
#define RKISP2_BLS_CTRL				(RKISP2_BLS_BASE + 0x00000)
#define RKISP2_BLS_SAMPLES			(RKISP2_BLS_BASE + 0x00004)
#define RKISP2_BLS_H1_START			(RKISP2_BLS_BASE + 0x00008)
#define RKISP2_BLS_H1_STOP			(RKISP2_BLS_BASE + 0x0000c)
#define RKISP2_BLS_V1_START			(RKISP2_BLS_BASE + 0x00010)
#define RKISP2_BLS_V1_STOP			(RKISP2_BLS_BASE + 0x00014)
#define RKISP2_BLS_H2_START			(RKISP2_BLS_BASE + 0x00018)
#define RKISP2_BLS_H2_STOP			(RKISP2_BLS_BASE + 0x0001c)
#define RKISP2_BLS_V2_START			(RKISP2_BLS_BASE + 0x00020)
#define RKISP2_BLS_V2_STOP			(RKISP2_BLS_BASE + 0x00024)
#define RKISP2_BLS_A_FIXED			(RKISP2_BLS_BASE + 0x00028)
#define RKISP2_BLS_B_FIXED			(RKISP2_BLS_BASE + 0x0002c)
#define RKISP2_BLS_C_FIXED			(RKISP2_BLS_BASE + 0x00030)
#define RKISP2_BLS_D_FIXED			(RKISP2_BLS_BASE + 0x00034)
#define RKISP2_BLS_A_MEASURED			(RKISP2_BLS_BASE + 0x00038)
#define RKISP2_BLS_B_MEASURED			(RKISP2_BLS_BASE + 0x0003c)
#define RKISP2_BLS_C_MEASURED			(RKISP2_BLS_BASE + 0x00040)
#define RKISP2_BLS_D_MEASURED			(RKISP2_BLS_BASE + 0x00044)
#define RKISP2_BLS1_A_FIXED			(RKISP2_BLS_BASE + 0x00048)
#define RKISP2_BLS1_B_FIXED			(RKISP2_BLS_BASE + 0x0004c)
#define RKISP2_BLS1_C_FIXED			(RKISP2_BLS_BASE + 0x00050)
#define RKISP2_BLS1_D_FIXED			(RKISP2_BLS_BASE + 0x00054)


#define RKISP2_DPCC_BASE			0x00003400
#define RKISP2_DPCC_MODE			(RKISP2_DPCC_BASE + 0x00000)
#define RKISP2_DPCC_OUTPUT_MODE			(RKISP2_DPCC_BASE + 0x00004)
#define RKISP2_DPCC_SET_USE			(RKISP2_DPCC_BASE + 0x00008)
#define RKISP2_DPCC_METHODS_SET_1		(RKISP2_DPCC_BASE + 0x0000c)
#define RKISP2_DPCC_METHODS_SET_2		(RKISP2_DPCC_BASE + 0x00010)
#define RKISP2_DPCC_METHODS_SET_3		(RKISP2_DPCC_BASE + 0x00014)
#define RKISP2_DPCC_LINE_THRESH_1		(RKISP2_DPCC_BASE + 0x00018)
#define RKISP2_DPCC_LINE_MAD_FAC_1		(RKISP2_DPCC_BASE + 0x0001c)
#define RKISP2_DPCC_PG_FAC_1			(RKISP2_DPCC_BASE + 0x00020)
#define RKISP2_DPCC_RND_THRESH_1		(RKISP2_DPCC_BASE + 0x00024)
#define RKISP2_DPCC_RG_FAC_1			(RKISP2_DPCC_BASE + 0x00028)
#define RKISP2_DPCC_LINE_THRESH_2		(RKISP2_DPCC_BASE + 0x0002c)
#define RKISP2_DPCC_LINE_MAD_FAC_2		(RKISP2_DPCC_BASE + 0x00030)
#define RKISP2_DPCC_PG_FAC_2			(RKISP2_DPCC_BASE + 0x00034)
#define RKISP2_DPCC_RND_THRESH_2		(RKISP2_DPCC_BASE + 0x00038)
#define RKISP2_DPCC_RG_FAC_2			(RKISP2_DPCC_BASE + 0x0003c)
#define RKISP2_DPCC_LINE_THRESH_3		(RKISP2_DPCC_BASE + 0x00040)
#define RKISP2_DPCC_LINE_MAD_FAC_3		(RKISP2_DPCC_BASE + 0x00044)
#define RKISP2_DPCC_PG_FAC_3			(RKISP2_DPCC_BASE + 0x00048)
#define RKISP2_DPCC_RND_THRESH_3		(RKISP2_DPCC_BASE + 0x0004c)
#define RKISP2_DPCC_RG_FAC_3			(RKISP2_DPCC_BASE + 0x00050)
#define RKISP2_DPCC_RO_LIMITS			(RKISP2_DPCC_BASE + 0x00054)
#define RKISP2_DPCC_RND_OFFS			(RKISP2_DPCC_BASE + 0x00058)
#define RKISP2_DPCC_BPT_CTRL			(RKISP2_DPCC_BASE + 0x0005c)
#define RKISP2_DPCC_BPT_NUMBER			(RKISP2_DPCC_BASE + 0x00060)
#define RKISP2_DPCC_BPT_ADDR			(RKISP2_DPCC_BASE + 0x00064)
#define RKISP2_DPCC_BPT_DATA			(RKISP2_DPCC_BASE + 0x00068)
#define RKISP2_DPCC_BP_CNT			(RKISP2_DPCC_BASE + 0x0006c)
#define RKISP2_DPCC_PDAF_EN			(RKISP2_DPCC_BASE + 0x00070)
#define RKISP2_DPCC_PDAF_POINT_EN		(RKISP2_DPCC_BASE + 0x00074)
#define RKISP2_DPCC_PDAF_OFFSET			(RKISP2_DPCC_BASE + 0x00078)
#define RKISP2_DPCC_PDAF_WRAP			(RKISP2_DPCC_BASE + 0x0007c)
#define RKISP2_DPCC_PDAF_SCOPE			(RKISP2_DPCC_BASE + 0x00080)
#define RKISP2_DPCC_PDAF_POINT_0		(RKISP2_DPCC_BASE + 0x00084)
#define RKISP2_DPCC_PDAF_POINT_1		(RKISP2_DPCC_BASE + 0x00088)
#define RKISP2_DPCC_PDAF_POINT_2		(RKISP2_DPCC_BASE + 0x0008c)
#define RKISP2_DPCC_PDAF_POINT_3		(RKISP2_DPCC_BASE + 0x00090)
#define RKISP2_DPCC_PDAF_POINT_4		(RKISP2_DPCC_BASE + 0x00094)
#define RKISP2_DPCC_PDAF_POINT_5		(RKISP2_DPCC_BASE + 0x00098)
#define RKISP2_DPCC_PDAF_POINT_6		(RKISP2_DPCC_BASE + 0x0009c)
#define RKISP2_DPCC_PDAF_POINT_7		(RKISP2_DPCC_BASE + 0x000a0)
#define RKISP2_DPCC_PDAF_FORWARD_MED		(RKISP2_DPCC_BASE + 0x000a4)

#define RKISP2_RAWNR_BASE			0x00003A00
#define RKISP2_BAYNR_CTRL			(RKISP2_RAWNR_BASE + 0x00000)
#define RKISP2_BAYNR_DGAIN0			(RKISP2_RAWNR_BASE + 0x00004)
#define RKISP2_BAYNR_DGAIN1			(RKISP2_RAWNR_BASE + 0x00008)
#define RKISP2_BAYNR_PIXDIFF			(RKISP2_RAWNR_BASE + 0x0000c)
#define RKISP2_BAYNR_THLD			(RKISP2_RAWNR_BASE + 0x00010)
#define RKISP2_BAYNR_W1_STRENG			(RKISP2_RAWNR_BASE + 0x00014)
#define RKISP2_BAYNR_SIGMAX01			(RKISP2_RAWNR_BASE + 0x00018)
#define RKISP2_BAYNR_SIGMAX23			(RKISP2_RAWNR_BASE + 0x0001c)
#define RKISP2_BAYNR_SIGMAX45			(RKISP2_RAWNR_BASE + 0x00020)
#define RKISP2_BAYNR_SIGMAX67			(RKISP2_RAWNR_BASE + 0x00024)
#define RKISP2_BAYNR_SIGMAX89			(RKISP2_RAWNR_BASE + 0x00028)
#define RKISP2_BAYNR_SIGMAX1011			(RKISP2_RAWNR_BASE + 0x0002c)
#define RKISP2_BAYNR_SIGMAX1213			(RKISP2_RAWNR_BASE + 0x00030)
#define RKISP2_BAYNR_SIGMAX1415			(RKISP2_RAWNR_BASE + 0x00034)
#define RKISP2_BAYNR_SIGMAY01			(RKISP2_RAWNR_BASE + 0x00038)
#define RKISP2_BAYNR_SIGMAY23			(RKISP2_RAWNR_BASE + 0x0003c)
#define RKISP2_BAYNR_SIGMAY45			(RKISP2_RAWNR_BASE + 0x00040)
#define RKISP2_BAYNR_SIGMAY67			(RKISP2_RAWNR_BASE + 0x00044)
#define RKISP2_BAYNR_SIGMAY89			(RKISP2_RAWNR_BASE + 0x00048)
#define RKISP2_BAYNR_SIGMAY1011			(RKISP2_RAWNR_BASE + 0x0004c)
#define RKISP2_BAYNR_SIGMAY1213			(RKISP2_RAWNR_BASE + 0x00050)
#define RKISP2_BAYNR_SIGMAY1415			(RKISP2_RAWNR_BASE + 0x00054)
#define RKISP2_BAYNR_WRIT_D			(RKISP2_RAWNR_BASE + 0x00058)

#define RKISP2_BAY3D_BASE			0x00003A00
#define RKISP2_BAY3D_CTRL			(RKISP2_BAY3D_BASE + 0x00080)
#define RKISP2_BAY3D_KALRATIO			(RKISP2_BAY3D_BASE + 0x00084)
#define RKISP2_BAY3D_GLBPK2			(RKISP2_BAY3D_BASE + 0x00088)
#define RKISP2_BAY3D_KALSTR			(RKISP2_BAY3D_BASE + 0x0008c)
#define RKISP2_BAY3D_WGTLMT			(RKISP2_BAY3D_BASE + 0x00090)
#define RKISP2_BAY3D_SIG_X0			(RKISP2_BAY3D_BASE + 0x00094)
#define RKISP2_BAY3D_SIG_X1			(RKISP2_BAY3D_BASE + 0x00098)
#define RKISP2_BAY3D_SIG_X2			(RKISP2_BAY3D_BASE + 0x0009c)
#define RKISP2_BAY3D_SIG_X3			(RKISP2_BAY3D_BASE + 0x000a0)
#define RKISP2_BAY3D_SIG_X4			(RKISP2_BAY3D_BASE + 0x000a4)
#define RKISP2_BAY3D_SIG_X5			(RKISP2_BAY3D_BASE + 0x000a8)
#define RKISP2_BAY3D_SIG_X6			(RKISP2_BAY3D_BASE + 0x000ac)
#define RKISP2_BAY3D_SIG_X7			(RKISP2_BAY3D_BASE + 0x000b0)
#define RKISP2_BAY3D_SIG_Y0			(RKISP2_BAY3D_BASE + 0x000b4)
#define RKISP2_BAY3D_SIG_Y1			(RKISP2_BAY3D_BASE + 0x000b8)
#define RKISP2_BAY3D_SIG_Y2			(RKISP2_BAY3D_BASE + 0x000bc)
#define RKISP2_BAY3D_SIG_Y3			(RKISP2_BAY3D_BASE + 0x000c0)
#define RKISP2_BAY3D_SIG_Y4			(RKISP2_BAY3D_BASE + 0x000c4)
#define RKISP2_BAY3D_SIG_Y5			(RKISP2_BAY3D_BASE + 0x000c8)
#define RKISP2_BAY3D_SIG_Y6			(RKISP2_BAY3D_BASE + 0x000cc)
#define RKISP2_BAY3D_SIG_Y7			(RKISP2_BAY3D_BASE + 0x000d0)

#define RKISP2_RAWAE_LITE_BASE			0x00004500
#define RKISP2_RAWAE_LITE_CTRL			(RKISP2_RAWAE_LITE_BASE + 0x00000)
#define RKISP2_RAWAE_LITE_BLK_SIZE		(RKISP2_RAWAE_LITE_BASE + 0x00004)
#define RKISP2_RAWAE_LITE_OFFSET		(RKISP2_RAWAE_LITE_BASE + 0x00008)
#define RKISP2_RAWAE_LITE_R2Y_CC		(RKISP2_RAWAE_LITE_BASE + 0x0000c)
#define RKISP2_RAWAE_LITE_RO_MEAN		(RKISP2_RAWAE_LITE_BASE + 0x00010)
#define RKISP2_RAWAE_LITE_RO_DBG1		(RKISP2_RAWAE_LITE_BASE + 0x00074)
#define RKISP2_RAWAE_LITE_RO_DBG2		(RKISP2_RAWAE_LITE_BASE + 0x00078)

#define RKISP2_RAWHIST_BIG1_BASE		0x00004800
#define RKISP2_RAWHIST_BIG2_BASE		0x00004A00
#define RKISP2_RAWHIST_BIG3_BASE		0x00004B00
#define RKISP2_RAWHIST_BIG_CTRL			(0x00000)
#define RKISP2_RAWHIST_BIG_SIZE			(0x00004)
#define RKISP2_RAWHIST_BIG_OFFS			(0x00008)
#define RKISP2_RAWHIST_BIG_HRAM_CTRL		(0x0000c)
#define RKISP2_RAWHIST_BIG_RAW2Y_CC		(0x00010)
#define RKISP2_RAWHIST_BIG_WRAM_CTRL		(0x00014)
#define RKISP2_RAWHIST_BIG_DBG1			(0x00020)
#define RKISP2_RAWHIST_BIG_DBG2			(0x00024)
#define RKISP2_RAWHIST_BIG_DBG3			(0x00028)
#define RKISP2_RAWHIST_BIG_WEIGHT_BASE		(0x00040)
#define RKISP2_RAWHIST_BIG_RO_BASE_BIN		(0x00080)


#define RKISP2_RAWHIST_LITE_BASE		0x00004900
#define RKISP2_RAWHIST_LITE_CTRL		(RKISP2_RAWHIST_LITE_BASE + 0x00000)
#define RKISP2_RAWHIST_LITE_SIZE		(RKISP2_RAWHIST_LITE_BASE + 0x00004)
#define RKISP2_RAWHIST_LITE_OFFS		(RKISP2_RAWHIST_LITE_BASE + 0x00008)
#define RKISP2_RAWHIST_LITE_RAM_CTRL		(RKISP2_RAWHIST_LITE_BASE + 0x0000c)
#define RKISP2_RAWHIST_LITE_RAW2Y_CC		(RKISP2_RAWHIST_LITE_BASE + 0x00010)
#define RKISP2_RAWHIST_LITE_DBG1		(RKISP2_RAWHIST_LITE_BASE + 0x00020)
#define RKISP2_RAWHIST_LITE_DBG2		(RKISP2_RAWHIST_LITE_BASE + 0x00024)
#define RKISP2_RAWHIST_LITE_DBG3		(RKISP2_RAWHIST_LITE_BASE + 0x00028)
#define RKISP2_RAWHIST_LITE_WEIGHT		(RKISP2_RAWHIST_LITE_BASE + 0x00040)
#define RKISP2_RAWHIST_LITE_RO_BASE_BIN		(RKISP2_RAWHIST_LITE_BASE + 0x00080)

#define RKISP2_RAWAF_BASE			0x00004D00
#define RKISP2_RAWAF_CTRL			(RKISP2_RAWAF_BASE + 0x00000)
#define RKISP2_RAWAF_LT_A			(RKISP2_RAWAF_BASE + 0x00004)
#define RKISP2_RAWAF_RB_A			(RKISP2_RAWAF_BASE + 0x00008)
#define RKISP2_RAWAF_LT_B			(RKISP2_RAWAF_BASE + 0x0000c)
#define RKISP2_RAWAF_RB_B			(RKISP2_RAWAF_BASE + 0x00010)
#define RKISP2_RAWAF_INT_LINE			(RKISP2_RAWAF_BASE + 0x00014)
#define RKISP2_RAWAF_GAUS_COE			(RKISP2_RAWAF_BASE + 0x00018)
#define RKISP2_RAWAF_THRES			(RKISP2_RAWAF_BASE + 0x0001c)
#define RKISP2_RAWAF_VAR_SHIFT			(RKISP2_RAWAF_BASE + 0x00020)
#define RKISP2_RAWAF_SUM_A			(RKISP2_RAWAF_BASE + 0x00024)
#define RKISP2_RAWAF_SUM_B			(RKISP2_RAWAF_BASE + 0x00028)
#define RKISP2_RAWAF_LUM_A			(RKISP2_RAWAF_BASE + 0x0002c)
#define RKISP2_RAWAF_LUM_B			(RKISP2_RAWAF_BASE + 0x00030)
#define RKISP2_RAWAF_GAMMA_Y0			(RKISP2_RAWAF_BASE + 0x00034)
#define RKISP2_RAWAF_GAMMA_Y1			(RKISP2_RAWAF_BASE + 0x00038)
#define RKISP2_RAWAF_GAMMA_Y2			(RKISP2_RAWAF_BASE + 0x0003c)
#define RKISP2_RAWAF_GAMMA_Y3			(RKISP2_RAWAF_BASE + 0x00040)
#define RKISP2_RAWAF_GAMMA_Y4			(RKISP2_RAWAF_BASE + 0x00044)
#define RKISP2_RAWAF_GAMMA_Y5			(RKISP2_RAWAF_BASE + 0x00048)
#define RKISP2_RAWAF_GAMMA_Y6			(RKISP2_RAWAF_BASE + 0x0004c)
#define RKISP2_RAWAF_GAMMA_Y7			(RKISP2_RAWAF_BASE + 0x00050)
#define RKISP2_RAWAF_GAMMA_Y8			(RKISP2_RAWAF_BASE + 0x00054)
#define RKISP2_RAWAF_INT_STATE			(RKISP2_RAWAF_BASE + 0x00058)
#define RKISP2_RAWAF_RAM_DATA			(RKISP2_RAWAF_BASE + 0x0005c)
